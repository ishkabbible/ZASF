...
//#define MIN_ENVELOPE_DB -60		//VDX - disabled; using now minEnvDB read from cfg file

class EnvelopeParams:public Presets
{
public:
    EnvelopeParams(unsigned char Penvstretch_,unsigned char Pforcedrelease_,ParamID *parID_);
    ~EnvelopeParams();
