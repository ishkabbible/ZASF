...
void ADvoicelistitem::cb_voicevolume_i(Fl_Value_Slider* o, void*) {
  ...
  pars->VoicePar[nvoice].b_changed = 10;
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"AddNote[Voice:Vol:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  paramID->nPart = pars->nPart;		  
		  paramID->nvoice = nvoice;
		  paramID->MidiVal = pars->VoicePar[nvoice].PPanning;
		  //paramID->SetName((const char*)env->parID->strName);
		  //paramID->SetName((const char*)pars->parID->strName);
		  //paramID->SetName((const char*)pars->parID->strName);
		  ...
		  sprintf(str1,"AddNote[Voice:Pan:p%d]",paramID->nPart);
...
//else
  if (nParIndex != -1) {
	//vst automation
	  midiRL->UpdateCompValue(nParIndex,pars->VoicePar[nvoice].PPanning,1);
...
Fl_Group* ADvoicelistitem::make_window() {
  { ADnoteVoiceListItem = new Fl_Group(0, 0, 615, 30);
    ...
    { Fl_Group* o = voicelistitemgroup = new Fl_Group(50, 0, 570, 25);
      ...
      { WidgetPDial* o = voicepanning = new WidgetPDial(master, 215, 5, 20, 20);
...
void ADvoicelistitem::refreshlist_g() {  
...
void ADvoiceUI::cb_Stereo_i(WidgetPDial* o, void*) {
  ...
  pars->VoicePar[nvoice].b_unison_changed  = 10;
  //Unison Stereo Spread Knob
}
...
//Unison Frequency Spread Slider
pars->VoicePar[nvoice].b_unison_changed = 10;
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  paramID->nPart = pars->nPart;		  
		  paramID->nvoice = nvoice;
		  paramID->MidiVal = pars->VoicePar[nvoice].PAmpVelocityScaleFunction;
		  //paramID->SetName((const char*)env->parID->strName);
		  //paramID->SetName((const char*)pars->parID->strName);
		  //paramID->SetName((const char*)pars->parID->strName);
		  ...
		  sprintf(str1,"AddNote[Voice:VelSns:p%d]",paramID->nPart);
  ...
  if (nParIndex != -1) {
	//vst automation
	  midiRL->UpdateCompValue(nParIndex,pars->VoicePar[nvoice].PAmpVelocityScaleFunction,1);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  paramID->nPart = pars->nPart;		  
		  paramID->nvoice = nvoice;
		  paramID->MidiVal = pars->VoicePar[nvoice].PDelay;
		  //paramID->SetName((const char*)env->parID->strName);
		  //paramID->SetName((const char*)pars->parID->strName);
		  //paramID->SetName((const char*)pars->parID->strName);
		  ...
		  sprintf(str1,"AddNote[Voice:Delay:p%d]",paramID->nPart);
  ...
  if (nParIndex != -1) {
	//vst automation
	  midiRL->UpdateCompValue(nParIndex,pars->VoicePar[nvoice].PDelay,1);
      ...
      { voicemodegroup = new Fl_Group(0, 5, 760, 575);
        { Fl_Group* o = voiceFMparametersgroup = new Fl_Group(530, 5, 230, 565, "MODULATOR");
          ...
          { modfrequency = new Fl_Group(535, 220, 220, 145, "Mod.FREQUENCY");
            ...
            { EnvelopeUI* o = voiceFMfreqenvgroup = new EnvelopeUI(540, 290, 205, 70, "ADSynth Modulator - Frequency Envelope");
              ...
              o->init(pars->VoicePar[nvoice].FMFreqEnvelope,master);
          ...
          { Fl_Group* o = new Fl_Group(535, 60, 220, 160, "Mod.AMPLITUDE");
            ...
            { EnvelopeUI* o = voiceFMampenvgroup = new EnvelopeUI(540, 145, 205, 70, "ADSynth Modulator - Amplitude Envelope");
              ...
              o->init(pars->VoicePar[nvoice].FMAmpEnvelope, master);
        ...
        { Fl_Group* o = new Fl_Group(5, 250, 525, 120, "FREQUENCY");
          ...
          { EnvelopeUI* o = voicefreqenvgroup = new EnvelopeUI(10, 290, 205, 70, "ADSynth Voice - Frequency Envelope");
            ...
            o->init(pars->VoicePar[nvoice].FreqEnvelope,master);
          ...
          { LFOUI* o = voicefreqlfogroup = new LFOUI(215, 290, 230, 70, "Frequency LFO     ");
            ...
            o->init(pars->VoicePar[nvoice].FreqLfo,master);
          ...
          { WidgetPDial* o = fixedfreqetdial = new WidgetPDial(master, 405, 255, 15, 15, "Eq.T.");
...
cy)");
        ...
        { Fl_Group* o = new Fl_Group(5, 525, 515, 45);
          ...
          { WidgetPDial* o = new WidgetPDial(master, 285, 540, 25, 25, "Stereo");
          ...
          { WidgetPDial* o = new WidgetPDial(master, 340, 540, 25, 25, "Vibratto");
            o->tooltip("Vibratto");
            o->box(FL_ROUND_UP_BOX);
            o->color(FL_BACKGROUND_COLOR);
            o->selection_color(FL_INACTIVE_COLOR);
          ...
          { Fl_Value_Output* o = unisonspreadoutput = new Fl_Value_Output(225, 545, 40, 15, "(cents)");
            ...
            unisonspreadoutput->align(FL_ALIGN_TOP_LEFT);
            o->value(pars->getUnisonFrequencySpreadCents(nvoice));
          } // Fl_Value_Output* unisonspreadoutput
          { WidgetPDial* o = new WidgetPDial(master, 390, 540, 25, 25, "Vib.speed");
      ...
      { Fl_Group* o = new Fl_Group(5, 40, 240, 210, "AMPLITUDE");
        ...
        o->labelsize(13);
        o->align(FL_ALIGN_TOP|FL_ALIGN_INSIDE);
        { Fl_Value_Slider* o = voladj = new Fl_Value_Slider(10, 60, 160, 15, "Vol");
          o->tooltip("Volume");
          o->type(5);
          o->box(FL_FLAT_BOX);
          o->labelsize(11);
        ...
        { Fl_Value_Slider* o = vsnsadj = new Fl_Value_Slider(10, 80, 160, 15, "V.Sns");
          o->tooltip("Velocity Sensing Function (rightmost to disable)");
          o->type(5);
          o->box(FL_FLAT_BOX);
          o->labelsize(11);
        ...
        { EnvelopeUI* o = voiceampenvgroup = new EnvelopeUI(10, 105, 205, 70, "ADSynth Voice - Amplitude Envelope");
          ...
          o->init(pars->VoicePar[nvoice].AmpEnvelope,master);
          if (pars->VoicePar[nvoice].PAmpEnvelopeEnabled==0) o->deactivate();
          voiceampenvgroup->end();
        } // EnvelopeUI* voiceampenvgroup
        { WidgetPDial* o = panadj = new WidgetPDial(master, 210, 60, 30, 30, "Pan");
        ...
        { LFOUI* o = voiceamplfogroup = new LFOUI(10, 175, 230, 70, "Amplitude LFO     ");
          ...
          o->init(pars->VoicePar[nvoice].AmpLfo,master);
      ...
      { Fl_Group* o = voicefiltergroup = new Fl_Group(245, 5, 285, 245, "FILTER");
        ...
        { FilterUI* o = voicefilterparamgroup = new FilterUI(250, 30, 275, 75, "ADsynth Voice - Filter");
          o->box(FL_FLAT_BOX);
          o->color(FL_LIGHT1);
          ...
          o->init(pars->VoicePar[nvoice].VoiceFilter,NULL,NULL,master);
          o->end();
        } // FilterUI* o
        { EnvelopeUI* o = voicefilterenvgroup = new EnvelopeUI(250, 105, 275, 70, "ADSynth Voice - Filter Envelope");
          ...
          o->init(pars->VoicePar[nvoice].FilterEnvelope,master);
        ...
        { LFOUI* o = voicefilterlfogroup = new LFOUI(250, 175, 230, 70, "Filter LFO     ");
          ...
          o->init(pars->VoicePar[nvoice].FilterLfo,master);
      ...
      { Fl_Group* o = new Fl_Group(115, 5, 95, 35);
        o->box(FL_THIN_UP_BOX);
        { Fl_Value_Slider* o = voicedelay = new Fl_Value_Slider(120, 21, 84, 12, "Delay");
          o->tooltip("Voice Delay");
          o->type(5);
          o->box(FL_FLAT_BOX);
          o->labelsize(11);
          o->maximum(127);
...
void ADvoiceUI::refresh_g() {

	voladj->value(pars->VoicePar[nvoice].PVolume);
	vsnsadj->value(pars->VoicePar[nvoice].PAmpVelocityScaleFunction);
	panadj->value(pars->VoicePar[nvoice].PPanning);
}
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"AddNote[Global:Vol:p%d]",paramID->nPart);
  ...
  if (nParIndex != -1) {
	//vst automation
	  midiRL->UpdateCompValue(nParIndex,(int)o->value (),1);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"AddNote[Global:Vel.Sns:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"AddNote[Global:Pan:p%d]",paramID->nPart);
  ...
  { ADnoteGlobalParameters = new Fl_Double_Window(535, 405, "ADsynth Global Parameters of the Instrument");
    ...
    { Fl_Group* o = new Fl_Group(5, 255, 525, 115, "FREQUENCY");
      ...
      { EnvelopeUI* o = freqenv = new EnvelopeUI(10, 295, 205, 70, "ADSynth Global - Frequency Envelope");
        ...
        o->init(pars->GlobalPar.FreqEnvelope,master);
        freqenv->end();
      } // EnvelopeUI* freqenv
      ...
      { LFOUI* o = freqlfo = new LFOUI(215, 295, 230, 70, "Frequency LFO     ");
        ...
        o->init(pars->GlobalPar.FreqLfo,master);
        freqlfo->end();
      } // LFOUI* freqlfo
      ...
      { WidgetPDial* o = new WidgetPDial(master, 500, 270, 25, 25, "relBW");
    ...
    { Fl_Group* o = new Fl_Group(5, 5, 240, 250, "AMPLITUDE");
      ...
      { WidgetPDial* o = pan = new WidgetPDial(master, 210, 25, 30, 30, "Pan");
      ...
      { WidgetPDial* o = pstr = new WidgetPDial(master, 125, 227, 25, 25, "P.Str.");
      ...
      { WidgetPDial* o = pt = new WidgetPDial(master, 155, 227, 25, 25, "P.t.");
      ...
      { WidgetPDial* o = pstc = new WidgetPDial(master, 185, 227, 25, 25, "P.Stc.");
      ...
      { WidgetPDial* o = pvel = new WidgetPDial(master, 215, 227, 25, 25, "P.Vel.");
      ...
      { EnvelopeUI* o = ampenv = new EnvelopeUI(10, 75, 205, 70, "ADSynth Global - Amplitude Envelope");
        ...
        o->init(pars->GlobalPar.AmpEnvelope,master);
        ampenv->end();
      } // EnvelopeUI* ampenv
      { LFOUI* o = amplfo = new LFOUI(10, 145, 230, 70, "Amplitude LFO          ");
        ...
        o->init(pars->GlobalPar.AmpLfo,master);
        amplfo->end();
      } // LFOUI* amplfo
    ...
    { Fl_Group* o = new Fl_Group(245, 5, 285, 250, "FILTER");
      ...
      { EnvelopeUI* o = filterenv = new EnvelopeUI(250, 110, 275, 70, "ADSynth Global - Filter Envelope");
        ...
        o->init(pars->GlobalPar.FilterEnvelope,master);
        filterenv->end();
      ...
      { LFOUI* o = filterlfo = new LFOUI(250, 180, 230, 70, "Filter LFO");
        ...
        o->init(pars->GlobalPar.FilterLfo,master);
        filterlfo->end();
      } // LFOUI* filterlfo
      { FilterUI* o = filterui = new FilterUI(250, 35, 275, 75, "ADsynth Global - Filter");
		...
		//***
		o->init(pars->GlobalPar.GlobalFilter,&pars->GlobalPar.PFilterVelocityScale,&pars->GlobalPar.PFilterVelocityScaleFunction,master);
        filterui->end();
      } // FilterUI* filterui
      o->end();
    } // Fl_Group* o
...
resui=new ResonanceUI(master, pars->GlobalPar.Reson);
make_window();
}
