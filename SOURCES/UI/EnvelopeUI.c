...
void EnvelopeUI::cb_e1adt_i(WidgetPDial* o, void*) {	//amp env
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  {
		  paramID->code = 1;	//A_dt
		  paramID->group = env->parID->group;
		  paramID->index = env->parID->index;
		  paramID->location = env->parID->location;
		  paramID->maxval = 127.0;
		  paramID->minval = 0.0;
		  paramID->nPart = env->parID->nPart;
		  paramID->nvoice = env->parID->nvoice;
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:A_dt:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:A_dt:p%d]",paramID->nPart);

		  strcat(paramID->strName, str1);

		  paramID->type = env->parID->type;
	  }
  ...
  freeedit->redraw();
	...
	if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:D_dt:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:D_dt:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:R_dt:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:R_dt:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:S_val:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:S_val:p%d]",paramID->nPart);
...
void EnvelopeUI::cb_e2aval_i(WidgetPDial* o, void*) {   //frequency envelope
	static int nParIndex = -2;
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:A_val:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:A_val:p%d]",paramID->nPart);
  ...
  freeedit->redraw();
    ...
    if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:R_val:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:R_val:p%d]",paramID->nPart);
...
void EnvelopeUI::cb_e3aval_i(WidgetPDial* o, void*) {	//Filter Env
	static int nParIndex = -2;
if (nParIndex<0)
  env->PA_val=(int)o->value();
  freeedit->redraw();
  ...
  freeedit->redraw();
    ...
    if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:D_val:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:D_val:p%d]",paramID->nPart);
...
void EnvelopeUI::cb_e4aval_i(WidgetPDial* o, void*) {		//bandwith env
	static int nParIndex = -2;
if (nParIndex<0)
  env->PA_val=(int)o->value();
  freeedit->redraw();
...
Fl_Double_Window* EnvelopeUI::make_freemode_edit_window() {
  { freemodeeditwindow = new Fl_Double_Window(575, 180, "Envelope");
    ...
    { WidgetPDial* o = envstretchdial = new WidgetPDial(master, 380, 155, 25, 25, "Str.");
...
Fl_Group* EnvelopeUI::make_ADSR_window() {
  { envADSR = new Fl_Group(0, 0, 205, 70);
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 205, 70, "Amplitude Envelope");
      ...
      { WidgetPDial* o = e1adt = new WidgetPDial(master, 5, 20, 30, 30, "A.dt");
      ...
      { WidgetPDial* o = e1ddt = new WidgetPDial(master, 40, 20, 30, 30, "D.dt");
      ...
      { WidgetPDial* o = e1rdt = new WidgetPDial(master, 110, 20, 30, 30, "R.dt");
      ...
      { WidgetPDial* o = e1sval = new WidgetPDial(master, 75, 20, 30, 30, "S.val");
      ...
      { WidgetPDial* o = e1envstretch = new WidgetPDial(master, 145, 25, 25, 25, "Stretch");
...
Fl_Group* EnvelopeUI::make_ASR_window() {
  { envASR = new Fl_Group(0, 0, 210, 70);
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 210, 70, "Frequency Envelope");
      ...
      o->labelsize(10);
      o->align(FL_ALIGN_TOP|FL_ALIGN_INSIDE);
      { WidgetPDial* o = e2aval = new WidgetPDial(master, 5, 20, 30, 30, "A.val");
      ...
      { WidgetPDial* o = e2adt = new WidgetPDial(master, 40, 20, 30, 30, "A.dt");
      ...
      { WidgetPDial* o = e2rval = new WidgetPDial(master, 110, 20, 30, 30, "R.val");
      ...
      { WidgetPDial* o = e2rdt = new WidgetPDial(master, 75, 20, 30, 30, "R.dt");
      ...
      { WidgetPDial* o = e2envstretch = new WidgetPDial(master, 145, 25, 25, 25, "Stretch");
...
Fl_Group* EnvelopeUI::make_ADSRfilter_window() {
  { envADSRfilter = new Fl_Group(0, 0, 275, 70);
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 275, 70, "Filter Envelope");
      ...
      o->labelsize(10);
      o->align(FL_ALIGN_TOP|FL_ALIGN_INSIDE);
      { WidgetPDial* o = e3aval = new WidgetPDial(master,5, 20, 30, 30, "A.val");
      ...
      { WidgetPDial* o = e3adt = new WidgetPDial(master, 40, 20, 30, 30, "A.dt");
      ...
      { WidgetPDial* o = e3dval = new WidgetPDial(master, 75, 20, 30, 30, "D.val");
      ...
      { WidgetPDial* o = e3ddt = new WidgetPDial(master, 110, 20, 30, 30, "D.dt");
      ...
      { WidgetPDial* o = e3rdt = new WidgetPDial(master, 145, 20, 30, 30, "R.dt");
      ...
      { WidgetPDial* o = e3rval = new WidgetPDial(master,180, 20, 30, 30, "R.val");
      ...
      { WidgetPDial* o = e3envstretch = new WidgetPDial(master, 215, 25, 25, 25, "Stretch");
...
Fl_Group* EnvelopeUI::make_ASRbw_window() {
  { envASRbw = new Fl_Group(0, 0, 210, 70);
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 210, 70, "BandWidth Envelope");
      ...
      o->labelsize(10);
      o->align(FL_ALIGN_TOP|FL_ALIGN_INSIDE);
      { WidgetPDial* o = e4aval = new WidgetPDial(master, 5, 20, 30, 30, "A.val");
      ...
      { WidgetPDial* o = e4adt = new WidgetPDial(master, 40, 20, 30, 30, "A.dt");
      ...
      { WidgetPDial* o = e4rval = new WidgetPDial(master, 110, 20, 30, 30, "R.val");
      ...
      { WidgetPDial* o = e4rdt = new WidgetPDial(master, 75, 20, 30, 30, "R.dt");
      ...
      { WidgetPDial* o = e4envstretch = new WidgetPDial(master, 145, 25, 25, 25, "Stretch");
...
void EnvelopeUI::init(EnvelopeParams *env_, Master* master_) {
	master = master_;
