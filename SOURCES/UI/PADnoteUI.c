...
REALTYPE* spectrum = new REALTYPE[lx];
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"PadNote[Global:Vol:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"PadNote[Global:Vel.Sns:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"PadNote[Global:Pan:p%d]",paramID->nPart);
...
oscui=NULL;
resui=new ResonanceUI(master, pars->resonance);
make_window();
}
    ...
    { Fl_Tabs* o = new Fl_Tabs(0, 0, 535, 395);
      ...
      { harmonicstructuregroup = new Fl_Group(0, 20, 535, 375, "Harmonic Structure");
        ...
        { Fl_Group* o = bwprofilegroup = new Fl_Group(5, 30, 90, 260);
          ...
          { WidgetPDial* o = hpbasepar1 = new WidgetPDial(master, 20, 75, 25, 25, "Width");
          ...
          { WidgetPDial* o = hpfreqmult = new WidgetPDial(master, 55, 75, 25, 25, "FreqMlt");
          ...
          { WidgetPDial* o = hpmpar1 = new WidgetPDial(master, 15, 115, 20, 20, "Str");
          ...
          { WidgetPDial* o = hpmfreq = new WidgetPDial(master,40, 115, 20, 20, "SFreq");
          ...
          { Fl_Group* o = new Fl_Group(10, 160, 80, 105);
            ...
            { WidgetPDial* o = hpamppar1 = new WidgetPDial(master, 15, 235, 25, 25, "Par1");
            ...
            { WidgetPDial* o = hpamppar2 = new WidgetPDial(master, 55, 235, 25, 25, "Par2");
          ...
          { WidgetPDial* o = hpwidth = new WidgetPDial(master, 65, 115, 20, 20, "Size");
        ...
        { WidgetPDial* o = bwdial = new WidgetPDial(master, 15, 295, 35, 35, "BandWidth");
        ...
        { Fl_Group* o = new Fl_Group(315, 295, 215, 45);
          ...
          { WidgetPDial* o = hrpospar1 = new WidgetPDial(master, 425, 310, 25, 25, "Par1");
          ...
          { WidgetPDial* o = hrpospar2 = new WidgetPDial(master, 460, 310, 25, 25, "Par2");
          ...
          { WidgetPDial* o = hrpospar3 = new WidgetPDial(master, 495, 310, 25, 25, "ForceH");
      ...
      { Fl_Group* o = envlfogroup = new Fl_Group(0, 20, 535, 375, "Envelopes&LFOs");
        o->box(FL_ENGRAVED_BOX);
        o->hide();
        { Fl_Group* o = new Fl_Group(5, 275, 525, 115, "FREQUENCY");
          ...
          { WidgetPDial* o = fixedfreqetdial = new WidgetPDial(master, 420, 295, 15, 15, "Eq.T.");
...
cy)");
        ...
        { Fl_Group* o = new Fl_Group(5, 25, 240, 250, "AMPLITUDE");
          ...
          { WidgetPDial* o = pan = new WidgetPDial(master, 210, 45, 30, 30, "Pan");
          ...
          { WidgetPDial* o = pstr = new WidgetPDial(master, 125, 247, 25, 25, "P.Str.");
          ...
          { WidgetPDial* o = pt = new WidgetPDial(master, 155, 247, 25, 25, "P.t.");
          ...
          { WidgetPDial* o = pstc = new WidgetPDial(master, 185, 247, 25, 25, "P.Stc.");
          ...
          { WidgetPDial* o = pvel = new WidgetPDial(master, 215, 247, 25, 25, "P.Vel.");
        ...
        { Fl_Group* o = new Fl_Group(245, 25, 285, 250, "FILTER");
          ...
          { EnvelopeUI* o = filterenv = new EnvelopeUI(250, 130, 275, 70, "PADSynth - Filter Envelope");
            ...
            o->init(pars->FilterEnvelope,master);
            filterenv->end();
          ...
          { FilterUI* o = filterui = new FilterUI(250, 55, 275, 75, "PADsynth - Filter");
            ...
            o->init(pars->GlobalFilter,&pars->PFilterVelocityScale,&pars->PFilterVelocityScaleFunction,master);
            filterui->end();
          } // FilterUI* filterui
          o->end();
        } // Fl_Group* o
