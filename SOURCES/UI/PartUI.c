...
Fl_Group* PartSysEffSend::make_window() {
  { syseffsend = new Fl_Group(0, 0, 115, 35);
    ...
    { WidgetPDial* o = new WidgetPDial(master, 0, 0, 25, 25, "01");
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  char *str1;		  
		  str1 = new char[100];
		  paramID->SetName("Global");

		  sprintf(str1,"[:Pan:p%d]",npart);

		  strcat(paramID->strName, str1);

		  paramID->type = S_GLOBAL;
	  }
...
void PartUI::cb_Volume_i(WidgetPDial* o, void*) {
	static int nParIndex = -2;
if (nParIndex<0)							//-1 returned by midiRL->FindComp(parID) means component not found!
...
if  ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Vel.Ofs:p%d]",npart);
...
if  ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Vel.Sns:p%d]",npart);
...
void PartUI::cb_Mode_i(Fl_Choice* o, void*) {
  ...
  if (o->value() > 2) {
	  part->Ppolymode = 0;
	  part->Plegatomode = 0;
	  part->Pexternal = ((int)o->value())-2;
	  //cmdEdit->deactivate();
	  chkNoteOn->deactivate();
	  part->Pnoteon = 0;
  }
  else
  {
...
Fl_Group* PartUI::make_window() {
  { partgroup = new Fl_Group(0, 0, 385, 180);
    ...
    { Fl_Group* o = partgroupui = new Fl_Group(0, 0, 385, 180);
      { WidgetPDial* o = pan = new WidgetPDial(master, 50, 40, 25, 25, "Pan");
        o->box(FL_ROUND_UP_BOX);
        o->color(FL_BACKGROUND_COLOR);
        o->selection_color(FL_INACTIVE_COLOR);
        o->labeltype(FL_NORMAL_LABEL);
...
nge the name or middle button to change the instrument information");
      ...
      { Fl_Check_Button* o = chkNoteOn = new Fl_Check_Button(10, 155, 65, 20, "NoteOn");
      ...
      { WidgetPDial* o = volume = new WidgetPDial(master, 10, 35, 30, 30, "Volume");
      ...
      { WidgetPDial* o = velofs = new WidgetPDial(master, 135, 40, 25, 25, "Vel.Ofs.");
      ...
      { WidgetPDial* o = velsns = new WidgetPDial(master, 95, 40, 25, 25, "Vel.Sns.");
      ...
      { Fl_Button* o = cmdEdit = new Fl_Button(15, 90, 130, 30, "Edit instrument");
        o->box(FL_PLASTIC_UP_BOX);
  ...
  { ctlwindow = new Fl_Double_Window(500, 130, "Controllers");
    ...
    { WidgetPDial* o = new WidgetPDial(master, 10, 55, 30, 30, "PanDpth");
    ...
    { WidgetPDial* o = new WidgetPDial(master, 90, 55, 30, 30, "FltCut");
    ...
    { WidgetPDial* o = new WidgetPDial(master, 50, 55, 30, 30, "FltQ");
    ...
    { WidgetPDial* o = new WidgetPDial(master, 125, 10, 30, 30, "BwDpth");
    ...
    { WidgetPDial* o = new WidgetPDial(master, 50, 10, 30, 30, "ModWh");
    ...
    { Fl_Group* o = new Fl_Group(280, 15, 160, 90, "Portamento");
      ...
      { WidgetPDial* o = new WidgetPDial(master, 285, 60, 25, 25, "time");
...
cents)");
      ...
      { WidgetPDial* o = new WidgetPDial(master, 315, 60, 25, 25, "t.dn/up");
      ...
      { WidgetPDial* o = propta = new WidgetPDial(master, 405, 20, 25, 25, "Prp.Rate");
        ...
        propta->align(FL_ALIGN_BOTTOM);
        propta->when(FL_WHEN_CHANGED);
        o->value(part->ctl.portamento.propRate);
      } // WidgetPDial* propta
      { WidgetPDial* o = proptb = new WidgetPDial(master, 405, 60, 25, 25, "Prp.Dpth");
    ...
    { Fl_Group* o = new Fl_Group(440, 15, 50, 90, "Resonance");
      ...
      o->labelfont(1);
      o->labelsize(10);
      { WidgetPDial* o = new WidgetPDial(master, 450, 60, 25, 25, "BWdpth");
      ...
      { WidgetPDial* o = new WidgetPDial(master, 450, 20, 25, 25, "CFdpth");
  ...
  { partfx = new Fl_Double_Window(390, 145, "Part\'s Insert Effects");
    ...
    { inseffectuigroup = new Fl_Group(5, 5, 380, 100);
      ...
      { EffUI* o = inseffectui = new EffUI(5, 5, 380, 95);
		...
		//***       
		o->init(part->partefx[ninseff],master);
        inseffectui->end();
      } // EffUI* inseffectui
...
void PartUI::refresh(){	 
	volume->value(part->Pvolume);
	pan->value(part->Ppanning);
	velsns->value(part->Pvelsns);
	velofs->value(part->Pveloffs);
}
...
if (kititem!=lastkititem){
    ...
    if (part->kit[kititem].subpars!=NULL) 
       subnoteui=new SUBnoteUI(part->kit[kititem].subpars,master);
