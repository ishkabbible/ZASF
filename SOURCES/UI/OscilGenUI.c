...
void Oscilloscope::draw() {
  ...
  REALTYPE* smps = new REALTYPE[OSCIL_SIZE];
...
oscil->Phmag[n]=x;
 ...
 while ((oscil->oscilpreparing)&&(oscil->b_changed))
	 oscil->b_changed--;
 ...
 if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  paramID->group = G_MAG,
		  paramID->index = n;
		  paramID->location = oscil->parID->location;
		  paramID->maxval = 127.0;
		  paramID->minval = 0.0;
		  paramID->nPart = oscil->parID->nPart;
		  paramID->nvoice = oscil->parID->nvoice;
		  paramID->MidiVal = (int) (o->value() *(127/paramID->maxval ));
		  //paramID->SetName((const char*)oscil->parID->strName);
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:mag(%d):p%d:v%d]",paramID->index+1,paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:mag(%d):p%d]",paramID->index+1,paramID->nPart);

		  strcat(paramID->strName, str1);

		  paramID->type = oscil->parID->type;
	  }
...
//pthread_mutex_lock(&master->mutex);
 ...
 if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  paramID->code = 2;	//phase
		  paramID->group = G_PHASE;
		  paramID->index = n;
		  paramID->location = oscil->parID->location;
		  paramID->maxval = 127.0;
		  paramID->minval = 0.0;
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:phase(%d):p%d:v%d]",paramID->index+1,paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:phase(%d):p%d]",paramID->index+1,paramID->nPart);
...
Fl_Double_Window* OscilEditor::make_window() {
 ...
 each harmonic");
      ...
      { Fl_Group* o = new Fl_Group(246, 277, 115, 25);
        ...
        { hrnddial = new WidgetPDial(master, 338, 280, 18, 18);
    ...
    { basefuncdisplaygroup = new Fl_Group(365, 5, 360, 300);
      ...
      { bfslider = new WidgetPDial(master, 520, 280, 20, 20);
      ...
      { basefuncmodulation = new Fl_Group(550, 276, 169, 25);
        ...
        { bfmodpar1 = new WidgetPDial(master, 659, 281, 15, 15);
        ...
        { bfmodpar2 = new WidgetPDial(master, 679, 281, 15, 15);
        ...
        { bfmodpar3 = new WidgetPDial(master, 699, 281, 15, 15);
    ...
    { Fl_Group* o = new Fl_Group(135, 308, 150, 30);
      ...
      { wshpar = new WidgetPDial(master, 260, 313, 20, 20);
    ...
    { Fl_Group* o = new Fl_Group(285, 308, 155, 30);
      ...
      { filtervalue1 = new WidgetPDial(master, 367, 313, 20, 20);
      ...
      { filtervalue2 = new WidgetPDial(master, 392, 313, 20, 20);
    ...
    { Fl_Group* o = new Fl_Group(590, 308, 135, 30);
      ...
      { sadjpar = new WidgetPDial(master, 695, 313, 20, 20);
    ...
    { Fl_Group* o = new Fl_Group(665, 410, 65, 90);
      ...
      { adhrpow = new WidgetPDial(master, 700, 460, 25, 25, "pow");
      ...
      { adhrbf = new WidgetPDial(master, 670, 460, 25, 25, "baseF");
    ...
    { Fl_Group* o = new Fl_Group(440, 308, 150, 30);
      ...
      { modpar1 = new WidgetPDial(master, 530, 315, 15, 15);
      ...
      { modpar2 = new WidgetPDial(master, 550, 315, 15, 15);
      ...
      { modpar3 = new WidgetPDial(master, 570, 315, 15, 15);
