...
public:
  SysEffSend(Master* master_, int x,int y, int w, int h, const char *label=0);
...
public:
  Fl_Button *cmdMidi;
private:
  void cb_cmdMidi_i(Fl_Button*, void*);
  static void cb_cmdMidi(Fl_Button*, void*);
public:
