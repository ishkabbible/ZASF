...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:Q:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:Q:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:Freq_tr:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:Freq_tr:p%d]",paramID->nPart);
...
if (nParIndex<0)
	if (velsnsamp!=NULL) {
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:VelAmp:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:VelAmp:p%d]",paramID->nPart);
	...
	if (velsns!=NULL) {
	  *velsns=(int)o->value();
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:VelSns:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:VelSns:p%d]",paramID->nPart);
...
if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  if (paramID->nvoice>=0)
			  sprintf(str1,"[:Gain:p%d:v%d]",paramID->nPart,paramID->nvoice);
		  else
			  sprintf(str1,"[:Gain:p%d]",paramID->nPart);
...
Fl_Group* FilterUI::make_window() {
  { filterui = new Fl_Group(0, 0, 275, 75);
    ...
    { filterparamswindow = new Fl_Group(0, 0, 275, 75, "Filter Parameters");
      ...
      { WidgetPDial* o = cfreqdial = new WidgetPDial(master, 75, 25, 30, 30, "C.Freq");
      ...
      { WidgetPDial* o = qdial = new WidgetPDial(master, 110, 25, 30, 30, "Q");
      ...
      { WidgetPDial* o = freqtrdial = new WidgetPDial(master, 215, 25, 30, 30, "freq.tr.");
...
ve)");
      ...
      { vsnsadial = new WidgetPDial(master, 145, 25, 30, 30, "V.SnsA.");
      ...
      { vsnsdial = new WidgetPDial(master, 180, 25, 30, 30, "V.Sns.");
      ...
      { WidgetPDial* o = gaindial = new WidgetPDial(master, 250, 35, 20, 20, "gain");
  ...
  { formantparswindow = new Fl_Double_Window(700, 205, "Formant Filter Parameters");
    ...
    { Fl_Group* o = new Fl_Group(485, 47, 105, 113);
      ...
      { formantparsgroup = new Fl_Group(490, 105, 95, 50);
        ...
        { formant_freq_dial = new WidgetPDial(master, 495, 115, 25, 25, "freq");
        ...
        { formant_q_dial = new WidgetPDial(master,525, 115, 24, 25, "Q");
        ...
        { formant_amp_dial = new WidgetPDial(master, 555, 115, 24, 25, "amp");
    ...
    { Fl_Group* o = new Fl_Group(590, 47, 100, 113);
      ...
      { WidgetPDial* o = strchdial = new WidgetPDial(master, 595, 130, 25, 25, "Strch");
    ...
    { WidgetPDial* o = frsldial = new WidgetPDial(master, 565, 15, 25, 25, "Fr.Sl.");
    ...
    { WidgetPDial* o = wvknob = new WidgetPDial(master, 600, 15, 25, 25, "Vw.Cl.");
...
void FilterUI::init(FilterParams *filterpars_,unsigned char *velsnsamp_,unsigned char *velsns_, Master* master_) {
	master = master_;
