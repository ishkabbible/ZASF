...
void EffUI::cb_revp0_i(WidgetPDial* o, void*) {		//reverb
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  {
		  paramID->code = 0;	//Vol
		  paramID->group = (GroupType)1; //reverb
		  paramID->index = eff->efx->parID->index;
		  paramID->location = eff->efx->parID->location;
		  paramID->maxval = 127.0;
		  paramID->minval = 0.0;
		  paramID->nPart = eff->efx->parID->nPart;
		  paramID->nvoice = -1;
		  paramID->MidiVal = (int) (o->value() *(127/paramID->maxval ));
		  
		  paramID->SetName((const char*)eff->efx->parID->strName);
		  ...
		  sprintf(str1,"[:Reverb:D/W:p%d]",paramID->nPart);

		  strcat(paramID->strName, str1);

		  paramID->type = eff->efx->parID->type;
	  }
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Reverb:Pan:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  paramID->code = 2;	//Time
		  paramID->group = (GroupType)1;
		  paramID->index = eff->efx->parID->index;	//1 2 3 ;)
		  paramID->location = eff->efx->parID->location;
		  paramID->maxval = 127.0;
		  paramID->minval = 0.0;
		  paramID->nPart = eff->efx->parID->nPart;
		  ...
		  sprintf(str1,"[:Reverb:Time:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Reverb:L.del:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Reverb:L.delfb:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Reverb:R.delay:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Reverb:E/R:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Reverb:LPF:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Reverb:HPF:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Reverb:Damp:p%d]",paramID->nPart);
...
void EffUI::cb_echop0_i(WidgetPDial* o, void*) {	//echo
	static int nParIndex = -2;
if (nParIndex<0)
  eff->seteffectpar(0,(int) o->value());
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Echo:D/W:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Echo:Pan:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Echo:Delay:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Echo:RLdl.:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Echo:LRc.:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Echo:Fb.:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Echo:Damp:p%d]",paramID->nPart);
...
void EffUI::cb_chorusp0_i(WidgetPDial* o, void*) {		//chorus
	static int nParIndex = -2;
if (nParIndex<0)
  eff->seteffectpar(0,(int) o->value());
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:Vol:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:Pan:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:Freq:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:Rnd:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:St.df:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:Depth:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:Delay:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:Fb:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Chorus:L/R:p%d]",paramID->nPart);
...
void EffUI::cb_phaserp0_i(WidgetPDial* o, void*) {		//phaser
	static int nParIndex = -2;
if (nParIndex<0)
  eff->seteffectpar(0,(int) o->value());
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:Vol:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:Pan:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:Freq:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:Rnd:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:St.df:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:Depth:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:Fb:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:L/R:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Phaser:Phase:p%d]",paramID->nPart);
...
void EffUI::cb_awp0_i(WidgetPDial* o, void*) {		//alenwah
	static int nParIndex = -2;
if (nParIndex<0)
  eff->seteffectpar(0,(int) o->value());
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:Vol:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:Pan:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:Freq:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:Rnd:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:St.df:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:Depth:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:Fb:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:L/R:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:AlienWah:Phase:p%d]",paramID->nPart);
...
void EffUI::cb_distp0_i(WidgetPDial* o, void*) {		//distorsion
	static int nParIndex = -2;
if (nParIndex<0)
  eff->seteffectpar(0,(int) o->value());
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Distorsion:Vol:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Distorsion:Pan:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Distorsion:LRc.:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Distorsion:Drive:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Distorsion:Level:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Distorsion:LPF:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:Distorsion:HPF:p%d]",paramID->nPart);
  ...
  if (nParIndex != -1) {
	//vst automation
	  midiRL->UpdateCompValue(nParIndex,(int) (o->value()*(127/127)),1);
...
void EffUI::cb_eqp0_i(WidgetPDial* o, void*) {		//EQ
	static int nParIndex = -2;
if (nParIndex<0)
  eff->seteffectpar(0,(int) o->value());
  eqgraph->redraw();
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  paramID->code = 0;	//MGain
		  paramID->group = (GroupType)7;
		  paramID->index = eff->efx->parID->index;
		  paramID->location = eff->efx->parID->location;
		  paramID->maxval = 127.0;
		  paramID->minval = 0.0;
		  ...
		  sprintf(str1,"[:EQ:MGain:p%d]",paramID->nPart);
...
if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:EQ:Freq:p%d]",paramID->nPart);
...
if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:EQ:Gain:p%d]",paramID->nPart);
...
if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[:EQ:Q:p%d]",paramID->nPart);
...
void EffUI::cb_dfp0_i(WidgetPDial* o, void*) {		//dynamic filter
	static int nParIndex = -2;
if (nParIndex<0)
  eff->seteffectpar(0,(int) o->value());
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[D/W:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[Pan:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[Rnd:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[St.df:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[LfoD:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[A.S.:p%d]",paramID->nPart);
...
if (nParIndex<0)
  ...
  if ((*LearningMidi)||(nParIndex!=-1)||(1)){
	  ...
	  paramID = new ParamID;
	  {
		  ...
		  sprintf(str1,"[A.M.:p%d]",paramID->nPart);
...
Fl_Group* EffUI::make_reverb_window() {
  { effreverbwindow = new Fl_Group(0, 0, 380, 95);
    ...
    { revp0 = new WidgetPDial(master, 10, 40, 30, 30, "Vol");
    ...
    { revp1 = new WidgetPDial(master, 45, 40, 30, 30, "Pan");
    ...
    { revp2 = new WidgetPDial(master, 80, 40, 30, 30, "Time");
    ...
    { revp3 = new WidgetPDial(master, 120, 40, 30, 30, "I.del");
    ...
    { revp4 = new WidgetPDial(master, 155, 40, 30, 30, "I.delfb");
    ...
    { WidgetPDial* o = revp12 = new WidgetPDial(master, 200, 40, 30, 30, "bw");
      ...
      revp12->align(FL_ALIGN_BOTTOM);
      revp12->when(FL_WHEN_RELEASE);
      revp12->deactivate();
      if (eff->geteffectpar(10)==2) o->activate();
    } // WidgetPDial* revp12
    { revp6 = new WidgetPDial(master, 235, 40, 30, 30, "E/R");
    ...
    { revp7 = new WidgetPDial(master, 270, 40, 30, 30, "LPF");
    ...
    { revp8 = new WidgetPDial(master, 305, 40, 30, 30, "HPF");
    ...
    { revp9 = new WidgetPDial(master, 340, 40, 30, 30, "Damp");
    ...
    { revp11 = new WidgetPDial(master, 200, 10, 25, 25, "R.S.");
...
Fl_Group* EffUI::make_echo_window() {
  { effechowindow = new Fl_Group(0, 0, 380, 95);
    ...
    { echop0 = new WidgetPDial(master, 10, 40, 30, 30, "Vol");
    ...
    { echop1 = new WidgetPDial(master, 45, 40, 30, 30, "Pan");
    ...
    { echop2 = new WidgetPDial(master, 80, 40, 30, 30, "Delay");
    ...
    { echop3 = new WidgetPDial(master, 120, 40, 30, 30, "LRdl.");
    ...
    { echop4 = new WidgetPDial(master, 155, 40, 30, 30, "LRc.");
    ...
    { echop5 = new WidgetPDial(master, 195, 40, 30, 30, "Fb.");
    ...
    { echop6 = new WidgetPDial(master, 235, 40, 30, 30, "Damp");
...
Fl_Group* EffUI::make_chorus_window() {
  { effchoruswindow = new Fl_Group(0, 0, 380, 95);
    ...
    { chorusp0 = new WidgetPDial(master, 10, 40, 30, 30, "Vol");
    ...
    { chorusp1 = new WidgetPDial(master, 45, 40, 30, 30, "Pan");
    ...
    { chorusp2 = new WidgetPDial(master, 85, 40, 30, 30, "Freq");
    ...
    { chorusp3 = new WidgetPDial(master, 120, 40, 30, 30, "Rnd");
    ...
    { chorusp5 = new WidgetPDial(master, 200, 40, 30, 30, "St.df");
    ...
    { chorusp6 = new WidgetPDial(master, 235, 40, 30, 30, "Dpth");
    ...
    { chorusp7 = new WidgetPDial(master, 270, 40, 30, 30, "Delay");
    ...
    { chorusp8 = new WidgetPDial(master, 305, 40, 30, 30, "Fb");
    ...
    { chorusp9 = new WidgetPDial(master, 340, 40, 30, 30, "L/R");
...
Fl_Group* EffUI::make_phaser_window() {
  { effphaserwindow = new Fl_Group(0, 0, 380, 95);
    ...
    { phaserp0 = new WidgetPDial(master, 10, 40, 30, 30, "Vol");
    ...
    { phaserp1 = new WidgetPDial(master, 45, 40, 30, 30, "Pan");
    ...
    { phaserp2 = new WidgetPDial(master, 85, 40, 30, 30, "Freq");
    ...
    { phaserp3 = new WidgetPDial(master, 120, 40, 30, 30, "Rnd");
    ...
    { phaserp5 = new WidgetPDial(master, 200, 40, 30, 30, "St.df");
    ...
    { phaserp6 = new WidgetPDial(master, 235, 40, 30, 30, "Dpth");
    ...
    { phaserp7 = new WidgetPDial(master, 270, 40, 30, 30, "Fb");
    ...
    { phaserp9 = new WidgetPDial(master, 345, 40, 30, 30, "L/R");
    ...
    { phaserp11 = new WidgetPDial(master, 155, 10, 25, 25, "Phase");
...
Fl_Group* EffUI::make_alienwah_window() {
  { effalienwahwindow = new Fl_Group(0, 0, 380, 95);
    ...
    { awp0 = new WidgetPDial(master, 10, 40, 30, 30, "Vol");
    ...
    { awp1 = new WidgetPDial(master, 45, 40, 30, 30, "Pan");
    ...
    { awp2 = new WidgetPDial(master, 85, 40, 30, 30, "Freq");
    ...
    { awp3 = new WidgetPDial(master, 120, 40, 30, 30, "Rnd");
    ...
    { awp5 = new WidgetPDial(master, 200, 40, 30, 30, "St.df");
    ...
    { awp6 = new WidgetPDial(master, 235, 40, 30, 30, "Dpth");
      awp6->tooltip("Depth");
    ...
    { awp7 = new WidgetPDial(master, 270, 40, 30, 30, "Fb");
    ...
    { awp9 = new WidgetPDial(master, 345, 40, 30, 30, "L/R");
    ...
    { awp10 = new WidgetPDial(master, 160, 5, 30, 30, "Phase");
...
Fl_Group* EffUI::make_distorsion_window() {
  { effdistorsionwindow = new Fl_Group(0, 0, 380, 95);
    ...
    { distp0 = new WidgetPDial(master, 10, 40, 30, 30, "Vol");
    ...
    { distp1 = new WidgetPDial(master, 45, 40, 30, 30, "Pan");
    ...
    { distp2 = new WidgetPDial(master, 80, 40, 30, 30, "LRc.");
    ...
    { distp3 = new WidgetPDial(master, 120, 40, 30, 30, "Drive");
    ...
    { distp4 = new WidgetPDial(master, 155, 40, 30, 30, "Level");
    ...
    { distp7 = new WidgetPDial(master, 285, 40, 30, 30, "LPF");
    ...
    { distp8 = new WidgetPDial(master, 320, 40, 30, 30, "HPF");
...
Fl_Group* EffUI::make_eq_window() {
  { effeqwindow = new Fl_Group(0, 0, 380, 95);
    ...
    { eqp0 = new WidgetPDial(master, 10, 35, 30, 30, "Gain");
    ...
    { Fl_Group* o = bandgroup = new Fl_Group(245, 40, 130, 50);
      ...
      { freqdial = new WidgetPDial(master, 250, 50, 25, 25, "Freq");
      ...
      { gaindial = new WidgetPDial(master, 280, 50, 25, 25, "Gain");
      ...
      { qdial = new WidgetPDial(master, 310, 50, 25, 25, "Q");
...
Fl_Group* EffUI::make_dynamicfilter_window() {
  { effdynamicfilterwindow = new Fl_Group(0, 0, 380, 95);
    ...
    { dfp0 = new WidgetPDial(master, 10, 40, 30, 30, "Vol");
    ...
    { dfp1 = new WidgetPDial(master, 45, 40, 30, 30, "Pan");
    ...
    { dfp2 = new WidgetPDial(master, 85, 40, 30, 30, "Freq");
    ...
    { dfp3 = new WidgetPDial(master, 120, 40, 30, 30, "Rnd");
    ...
    { dfp5 = new WidgetPDial(master, 200, 40, 30, 30, "St.df");
    ...
    { dfp6 = new WidgetPDial(master, 235, 40, 30, 30, "LfoD");
    ...
    { Fl_Group* o = new Fl_Group(270, 40, 105, 45);
      ...
      { dfp7 = new WidgetPDial(master, 275, 45, 25, 25, "A.S.");
      ...
      { dfp9 = new WidgetPDial(master, 305, 45, 25, 25, "A.M");
...
Fl_Double_Window* EffUI::make_filter_window() {
  { filterwindow = new Fl_Double_Window(290, 110, "Filter Parameters for DynFilter Eff.");
    ...
    { FilterUI* o = groupfilterui = new FilterUI(5, 5, 275, 75, "DynFilter effect  - Filter");
      o->box(FL_FLAT_BOX);
      o->color(FL_LIGHT1);
      ...
      o->init(eff->filterpars,NULL,NULL,master);
...
void EffUI::init(EffectMgr *eff_, Master* master_) {
  eff=eff_;
  master=master_;
...
Fl_Group* SimpleEffUI::make_reverb_window() {
  { effreverbwindow = new Fl_Group(0, 0, 230, 95);
    ...
    { revp2 = new WidgetPDial(master, 45, 40, 30, 30, "Time");
    ...
    { revp3 = new WidgetPDial(master, 85, 40, 30, 30, "I.del");
      revp3->tooltip("Initial Delay");
      revp3->box(FL_ROUND_UP_BOX);
      revp3->color(FL_BACKGROUND_COLOR);
      revp3->selection_color(FL_INACTIVE_COLOR);
    ...
    { revp9 = new WidgetPDial(master, 120, 40, 30, 30, "Damp");
      revp9->tooltip("Dampening");
      revp9->box(FL_ROUND_UP_BOX);
      revp9->color(FL_BACKGROUND_COLOR);
      revp9->selection_color(FL_INACTIVE_COLOR);
...
Fl_Group* SimpleEffUI::make_echo_window() {
  { effechowindow = new Fl_Group(0, 0, 230, 95);
    ...
    { echop2 = new WidgetPDial(master, 45, 40, 30, 30, "Delay");
      echop2->box(FL_ROUND_UP_BOX);
      echop2->color(FL_BACKGROUND_COLOR);
      echop2->selection_color(FL_INACTIVE_COLOR);
      echop2->labeltype(FL_NORMAL_LABEL);
    ...
    { echop5 = new WidgetPDial(master, 80, 40, 30, 30, "Fb.");
      echop5->tooltip("Feedback");
      echop5->box(FL_ROUND_UP_BOX);
      echop5->color(FL_BACKGROUND_COLOR);
      echop5->selection_color(FL_INACTIVE_COLOR);
...
Fl_Group* SimpleEffUI::make_chorus_window() {
  { effchoruswindow = new Fl_Group(0, 0, 230, 95);
    ...
    { chorusp2 = new WidgetPDial(master, 45, 40, 30, 30, "Freq");
      chorusp2->tooltip("LFO Frequency");
      chorusp2->box(FL_ROUND_UP_BOX);
      chorusp2->color(FL_BACKGROUND_COLOR);
      chorusp2->selection_color(FL_INACTIVE_COLOR);
    ...
    { chorusp6 = new WidgetPDial(master, 80, 40, 30, 30, "Dpth");
    ...
    { chorusp7 = new WidgetPDial(master, 115, 40, 30, 30, "Delay");
      chorusp7->box(FL_ROUND_UP_BOX);
      chorusp7->color(FL_BACKGROUND_COLOR);
      chorusp7->selection_color(FL_INACTIVE_COLOR);
      chorusp7->labeltype(FL_NORMAL_LABEL);
    ...
    { chorusp8 = new WidgetPDial(master, 150, 40, 30, 30, "Fb");
      chorusp8->tooltip("Feedback");
      chorusp8->box(FL_ROUND_UP_BOX);
      chorusp8->color(FL_BACKGROUND_COLOR);
      chorusp8->selection_color(FL_INACTIVE_COLOR);
...
Fl_Group* SimpleEffUI::make_phaser_window() {
  { effphaserwindow = new Fl_Group(0, 0, 230, 95);
    ...
    { phaserp2 = new WidgetPDial(master, 45, 40, 30, 30, "Freq");
      phaserp2->tooltip("LFO frequency");
      phaserp2->box(FL_ROUND_UP_BOX);
      phaserp2->color(FL_BACKGROUND_COLOR);
      phaserp2->selection_color(FL_INACTIVE_COLOR);
    ...
    { phaserp5 = new WidgetPDial(master, 80, 40, 30, 30, "St.df");
      phaserp5->tooltip("Left/Right Channel Phase Shift");
      phaserp5->box(FL_ROUND_UP_BOX);
      phaserp5->color(FL_BACKGROUND_COLOR);
      phaserp5->selection_color(FL_INACTIVE_COLOR);
    ...
    { phaserp6 = new WidgetPDial(master, 115, 40, 30, 30, "Dpth");
    ...
    { phaserp7 = new WidgetPDial(master, 150, 40, 30, 30, "Fb");
      phaserp7->tooltip("Feedback");
      phaserp7->box(FL_ROUND_UP_BOX);
      phaserp7->color(FL_BACKGROUND_COLOR);
      phaserp7->selection_color(FL_INACTIVE_COLOR);
...
Fl_Group* SimpleEffUI::make_alienwah_window() {
  { effalienwahwindow = new Fl_Group(0, 0, 230, 95);
    ...
    { awp2 = new WidgetPDial(master, 45, 40, 30, 30, "Freq");
      awp2->tooltip("LFO frequency");
      awp2->box(FL_ROUND_UP_BOX);
      awp2->color(FL_BACKGROUND_COLOR);
      awp2->selection_color(FL_INACTIVE_COLOR);
    ...
    { awp6 = new WidgetPDial(master, 85, 40, 30, 30, "Dpth");
      awp6->tooltip("Depth");
      awp6->box(FL_ROUND_UP_BOX);
      awp6->color(FL_BACKGROUND_COLOR);
      awp6->selection_color(FL_INACTIVE_COLOR);
...
Fl_Group* SimpleEffUI::make_distorsion_window() {
  { effdistorsionwindow = new Fl_Group(0, 0, 230, 95);
    ...
    { distp3 = new WidgetPDial(master, 45, 40, 30, 30, "Drive");
      distp3->tooltip("Input amplification");
      distp3->box(FL_ROUND_UP_BOX);
      distp3->color(FL_BACKGROUND_COLOR);
      distp3->selection_color(FL_INACTIVE_COLOR);
    ...
    { distp4 = new WidgetPDial(master, 80, 40, 30, 30, "Level");
      distp4->tooltip("Output Amplification");
      distp4->box(FL_ROUND_UP_BOX);
      distp4->color(FL_BACKGROUND_COLOR);
      distp4->selection_color(FL_INACTIVE_COLOR);
    ...
    { distp7 = new WidgetPDial(master, 190, 40, 30, 30, "LPF");
      distp7->tooltip("Low Pass Filter");
      distp7->box(FL_ROUND_UP_BOX);
      distp7->color(FL_BACKGROUND_COLOR);
      distp7->selection_color(FL_INACTIVE_COLOR);
...
Fl_Group* SimpleEffUI::make_eq_window() {
  { effeqwindow = new Fl_Group(0, 0, 230, 95);
    ...
    { Fl_Group* o = bandgroup = new Fl_Group(5, 5, 75, 85);
      bandgroup->box(FL_ENGRAVED_FRAME);
      { freqdial = new WidgetPDial(master, 10, 10, 25, 25, "Freq");
        freqdial->box(FL_ROUND_UP_BOX);
        freqdial->color(FL_BACKGROUND_COLOR);
        freqdial->selection_color(FL_INACTIVE_COLOR);
        freqdial->labeltype(FL_NORMAL_LABEL);
      ...
      { gaindial = new WidgetPDial(master, 45, 10, 25, 25, "Gain");
        gaindial->box(FL_ROUND_UP_BOX);
        gaindial->color(FL_BACKGROUND_COLOR);
        gaindial->selection_color(FL_INACTIVE_COLOR);
        gaindial->labeltype(FL_NORMAL_LABEL);
      ...
      { qdial = new WidgetPDial(master, 10, 50, 25, 25, "Q");
...
Fl_Group* SimpleEffUI::make_dynamicfilter_window() {
  { effdynamicfilterwindow = new Fl_Group(0, 0, 230, 95);
    ...
    { dfp2 = new WidgetPDial(master, 45, 40, 30, 30, "Freq");
      dfp2->tooltip("LFO frequency");
      dfp2->box(FL_ROUND_UP_BOX);
      dfp2->color(FL_BACKGROUND_COLOR);
      dfp2->selection_color(FL_INACTIVE_COLOR);
    ...
    { dfp6 = new WidgetPDial(master, 80, 40, 30, 30, "LfoD");
      dfp6->tooltip("LFO depth");
      dfp6->box(FL_ROUND_UP_BOX);
      dfp6->color(FL_BACKGROUND_COLOR);
      dfp6->selection_color(FL_INACTIVE_COLOR);
    ...
    { Fl_Group* o = new Fl_Group(115, 40, 65, 45);
      o->box(FL_BORDER_BOX);
      o->color((Fl_Color)181);
      { dfp7 = new WidgetPDial(master, 120, 45, 25, 25, "A.S.");
      ...
      { dfp9 = new WidgetPDial(master, 150, 45, 25, 25, "A.M");
...
void SimpleEffUI::init(EffectMgr *eff_, Master* master_) {
  eff=eff_;
  master = master_;
  LearningMidi =( master->LearningMidi);
  midiRL = master->theVST->midiRL;
