...
public:
     ...
     */
    Echo(const int & insertion_,REALTYPE *const efxoutl_,REALTYPE *const efxoutr_,ParamID *parID_);
...
private:
	...
	//void setdelay_rl(const unsigned char & Pdelay);
