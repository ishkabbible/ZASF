...
DynamicFilter::DynamicFilter(int insertion_,REALTYPE *efxoutl_,REALTYPE *efxoutr_,ParamID *parID_,ParamID *parFltID_)
        :Effect(insertion_,efxoutl_,efxoutr_,new FilterParams(0,64,64,parFltID_),0,parID_),
...
void DynamicFilter::out(REALTYPE *smpsl,REALTYPE *smpsr)
{
    ...
    REALTYPE ampsmooth2=pow(ampsmooth,0.2f)*0.3;
